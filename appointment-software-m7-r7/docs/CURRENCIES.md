...
PayPal documents account/country restrictions for `BRL`, `CNY`, and `MYR`. Payment-account eligibility will be validated when Stripe and PayPal account connections are implemented in M8.
