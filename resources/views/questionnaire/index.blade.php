...
<div class="page-heading actions" style="justify-content:space-between">
 ...
 <div class="actions"><a class="btn" href="{{ route('appointment-types.edit',$appointmentType) }}">Back to appointment type</a><a class="btn btn-primary" href="{{ route('appointment-types.questions.create',$appointmentType) }}">Add question</a></div>
</div>
...
<tr>
 <td>{{ $question->position }}</td><td><strong>{{ $question->label }}</strong>@if($question->description)<div class="muted">{{ \Illuminate\Support\Str::limit($question->description,90) }}</div>@endif</td>
