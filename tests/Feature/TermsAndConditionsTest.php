...
class TermsAndConditionsTest extends TestCase
{
    public function test_terms_are_publicly_available_at_the_required_path(): void
    {
        $this->get('/a/terms.html')
            ...
            ->assertSee('binding agreement between you and OKay Inc.')
            ->assertSee('owned by OKay Inc. or its licensors')
            ->assertSee('OKay Inc. Parties')
            ->assertDontSee('owned by Appointment.to or its licensors')
