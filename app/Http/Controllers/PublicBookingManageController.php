...
class PublicBookingManageController extends Controller
{
    ...
    public function show(
        ...
        $booking->load(['organization.paymentSettings', 'appointmentType', 'appointment', 'attendees', 'tickets.attendee', 'contractTemplate', 'contractSubmissions.files', 'answers.files', 'priceLines', 'taxLines', 'resourceDeposits', 'resourceConfirmations', 'reschedules', 'scheduleProposals.proposedBy', 'payments.refunds', 'refunds.transaction']);
