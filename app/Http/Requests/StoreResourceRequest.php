...
class StoreResourceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'person_uuid' => ['exclude_unless:type,person', 'nullable', 'uuid'],
            'timezone' => ['exclude_unless:type,person', 'nullable', new IanaTimezone()],
            'default_requirement' => ['nullable', 'in:required,optional'],
            'enforce_holidays' => ['exclude_unless:type,person', 'nullable', 'boolean'],
            'holiday_region' => [
                'exclude_unless:type,person',
                Rule::requiredIf(fn (): bool => $this->input('type') === 'person' && $this->boolean('enforce_holidays')),
                'nullable',
                'string',
