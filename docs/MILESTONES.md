...
- **M5 Questionnaire + Pricing — complete:** unlimited questions, chargeable checkbox/select/number answers, files, email/phone/address verification and deterministic price snapshots.
