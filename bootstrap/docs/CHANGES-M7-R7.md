...
The resource create/edit form now receives the active organization explicitly, including when editing resources created before M7-R7, so organization-specific holiday settings render correctly.
